...
const evolutionMap = {
  ...
  // ═══════════════════════════════════════════════════════════════════════════════
  // ADDITIONS — all remaining Gen I–IV Pokémon not in the Platinum checklist
  // Keys use standard species names (PokeAPI lowercase + hyphens).
  // ═══════════════════════════════════════════════════════════════════════════════

  // ── Gen I additions (Bulbasaur → Mew) ────────────────────────────────────────
  "bulbasaur":        ["venusaur"],
  "ivysaur":          ["venusaur"],
  "venusaur":         ["venusaur"],
  ...
  // ── Gen II additions (Chikorita → Celebi) ────────────────────────────────────
  "chikorita":        ["meganium"],
  "bayleef":          ["meganium"],
  "meganium":         ["meganium"],
  ...
  // ── Gen III additions (Treecko → Deoxys) ─────────────────────────────────────
  "treecko":          ["sceptile"],
  "grovyle":          ["sceptile"],
  "sceptile":         ["sceptile"],
  "torchic":          ["blaziken"],
  ...
  // ── Gen IV additions (Turtwig → Manaphy) ─────────────────────────────────────
  "turtwig":          ["torterra"],
  "grotle":           ["torterra"],
  "torterra":         ["torterra"],
  "chimchar":         ["infernape"],
